...
def compare_state_machines(rtl_state_machine, specs_chapter_content, module_name):
    ...
    "  - Do not consider differences in how the logical conditions are structured as a mismatch if the logical conditions are equivalent.\n"
    ...
    "  - **Explanation:** Both conditions are logically equivalent after simplification and should be considered matching.\n"        
        ...
        "- **Consider logically equivalent conditions as matching, even if they are structured differently.**\n"
        "- **Do not consider differences in logical expression structures as mismatches if they are logically equivalent.**\n"        
